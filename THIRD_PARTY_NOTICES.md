...
Price information is requested at runtime from Instant Gaming's public-facing
`ext_api` endpoint. No copy of Instant Gaming's catalogue is distributed with
the plugin. The endpoint is undocumented and may change or become unavailable.
